...
type Step = "setup" | "training" | "evaluation" | "results";
...
function workflow(study: Study): void {
  ...
  const steps: Step[] = ["setup", "training", "evaluation", "results"];
  const draw = (): void => {
